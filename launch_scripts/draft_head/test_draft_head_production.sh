#!/usr/bin/env bash
# Run a small draft-head diagnostic with target-regenerated oracle context.
set -euo pipefail
...
DRAFT_HEAD_CHECKPOINT_PATH="${DRAFT_HEAD_CHECKPOINT_PATH:-$PROJECT_ROOT/outputs/draft_head/checkpoints/20260531_073122_moviegen_draft_head_attention_scheduled_h5120_l3_heads40_ctx512_pool1x4x4_ffn13824_steps1000_937_833_625_0_blocks9_targetinit8_16_24/epoch_0002.pt}"

OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/draft_head/test_runs/draft_head_$(date +%Y%m%d_%H%M%S)}"
...
log "Draft-head oracle-context diagnostic"
